...
#include "HbkProjectile_Em7500GroundSlash808.generated.h"
...
class HIBIKI_API AHbkProjectile_Em7500GroundSlash808 : public AHbkProjectileWithoutMesh {
    GENERATED_BODY()
public:
protected:
...
public:
    AHbkProjectile_Em7500GroundSlash808(const FObjectInitializer& ObjectInitializer);
