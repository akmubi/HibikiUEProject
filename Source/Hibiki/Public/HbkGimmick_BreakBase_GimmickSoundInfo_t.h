...
#include "Engine/EngineTypes.h"
#include "HbkGimmick_BreakBase_GimmickSoundInfo_t.generated.h"

USTRUCT(BlueprintType)
struct FHbkGimmick_BreakBase_GimmickSoundInfo_t {
    GENERATED_BODY()
public:
    ...
    HIBIKI_API FHbkGimmick_BreakBase_GimmickSoundInfo_t();
};
