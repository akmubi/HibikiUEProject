...
#include "KaleStatueDropItemRow.h"
#include "HbkGimmick_BreakKaleStatue.generated.h"
...
class HIBIKI_API AHbkGimmick_BreakKaleStatue : public AHbkGimmick_BreakBase {
    GENERATED_BODY()
public:
protected:
...
private:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Transient, meta=(AllowPrivateAccess=true))
    FKaleStatueDropItemRow DropItemData;
...
public:
    AHbkGimmick_BreakKaleStatue(const FObjectInitializer& ObjectInitializer);
