...
#include "HbkAnimNotifyState_em0570_ArmBeam.generated.h"

class UAkAudioEvent;
class UParticleSystem;

UCLASS(Blueprintable, CollapseCategories, EditInlineNew)
class UHbkAnimNotifyState_em0570_ArmBeam : public UAnimNotifyState {
    GENERATED_BODY()
public:
protected:
...
public:
    UHbkAnimNotifyState_em0570_ArmBeam();
