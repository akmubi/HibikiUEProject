...
AHbkEnemyFireGroup_Em0210Wave::AHbkEnemyFireGroup_Em0210Wave(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    ...
    this->bSpawnFireEveryFrame = false;
