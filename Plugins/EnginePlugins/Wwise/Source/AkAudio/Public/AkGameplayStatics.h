...
#include "AkComponentOcclusionCollisionChannelType.h"
#include "AkExternalSourceInfo.h"
#include "AkGameObjType.h"
...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintCosmetic)
    static void SetRTPCValueGlobal(FName RTPC, float Value, int32 InterpolationTimeMs, AkGameObjType Type);
    ...
    UFUNCTION(BlueprintCallable, BlueprintCosmetic)
    static void SeekOnEventGlobalByPosition(const FString& in_EventName, int32 in_PositionMsec, bool in_bSeekToNearestMarker, int32 InPlayingID);
    
    UFUNCTION(BlueprintCallable, BlueprintCosmetic)
    static void SeekOnEventGlobal(const FString& in_EventName, float in_fPercent, bool in_bSeekToNearestMarker, int32 InPlayingID);
    
    UFUNCTION(BlueprintCallable, BlueprintCosmetic)
    static void SeekOnEventByPosition(const FString& in_EventName, AActor* in_pActor, int32 in_PositionMsec, bool in_bSeekToNearestMarker, int32 InPlayingID);
    
    UFUNCTION(BlueprintCallable, BlueprintCosmetic)
    static void SeekOnEvent(const FString& in_EventName, AActor* in_pActor, float in_fPercent, bool in_bSeekToNearestMarker, int32 InPlayingID);
    
    UFUNCTION(BlueprintCallable, BlueprintCosmetic)
    static bool Resume(int32 PlayingID, int32 FadeTimeMs);
    ...
    UFUNCTION(BlueprintCallable, BlueprintCosmetic)
    static int32 PostEventGlobalWithCallback(UAkAudioEvent* AkEvent, int32 CallbackMask, const FOnAkPostEventCallback& PostEventCallback, AkGameObjType Type);
    
    UFUNCTION(BlueprintCallable, BlueprintCosmetic)
    static int32 PostEventGlobal(UAkAudioEvent* AkEvent, AkGameObjType Type);
    ...
    UFUNCTION(BlueprintCallable, BlueprintCosmetic)
    static bool Pause(int32 PlayingID, int32 FadeTimeMs);
    ...
    UFUNCTION(BlueprintCallable, BlueprintCosmetic)
    static bool IsBankLoaded(UAkAudioEvent* Event);
    ...
    UFUNCTION(BlueprintCallable, BlueprintCosmetic)
    static bool GetCollisionChannel(AkComponentOcclusionCollisionChannelType Type, TEnumAsByte<ECollisionChannel>& CollisionChannel);
